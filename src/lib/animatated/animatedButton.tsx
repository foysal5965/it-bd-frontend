...
const AnimatedButton = ({name,variant, onClick,background}:AnimatedButton) => {
  return (
    <motion.div
      whileHover={{
    ...
    >
      ...
      variant= {variant ? variant : "contained"}
        sx={{
          background: background ? background : 'linear-gradient(45deg, #FE6B8B 30%, #FF8E53 90%)', // Gradient color
