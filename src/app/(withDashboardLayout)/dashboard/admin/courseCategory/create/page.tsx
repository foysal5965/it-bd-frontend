...
import { useAddCourseCategoryWithFormDataMutation } from '@/redux/api/courseCategory.api';
...
const CreateCourseCategory = () => {
    ...
    // Hook from Redux to trigger the mutation
    const [addCourseCategoryWithFormData, { isLoading, isSuccess, isError }] = useAddCourseCategoryWithFormDataMutation();
